...
public class TodoDatabaseTest {
    ...
    public void createDb() {
        ...
        edgeDao = db.edgeDao();
        nodeDao = db.nodeDao();
        testNode = new ZooData.Node("test-exhibit", "exhibit", "test", Arrays.asList(new String[]{"test", "tag1", "penguins"}),0.0,0.0);
        testNode2 = new ZooData.Node("test-exhibit2", "exhibit", "test2", Arrays.asList(new String[]{"tag1", "penguins"}), 0.0, 0.0);
        testNode3 = new ZooData.Node("test-exhibit3", "exhibit", "test3", Arrays.asList(new String[]{"penguins"}), 0.0,0.0);
